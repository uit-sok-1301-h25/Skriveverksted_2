...
subtitle: "SOK-1301 H25"       # Undertittel
...
Du kan srive symboler og ligninger lekende lett med LaTeX-syntaks:
...
Det finnes massse gode ressurser på nettet for hvordan man skriver ligninger i Quarto, f.eks. [her](https://qmd4sci.njtierney.com/math.html).
...
5.  Bonus: Legg til eller fjern en kolonne via **Table → Edit Table** i menyen, og render igjen for å se forskjellen.
:::
...
Eksempel i teksten: @kahneman1979a er den mest siterte artikkelen innen samfunnsøkønomi gjennom tidene, mens @baker2016 har mest siteringer av samfunnsøkonomiske artikler siden 2010. Quarto lager automatisk en referanseliste på slutten av dokumentet, basert på kildene du har sitert [@andreasson2017; @akerlof1970].

::: callout-tip
Oppgave: Sett inn sitering

Bruk Insert → Citation til å sette inn en vilkårlig referanse fra Zotero (eller en testnøkkel i references.bib).

Siter samme kilde to ganger i teksten. Render og sjekk at den bare vises én gang i referanselisten.
:::
